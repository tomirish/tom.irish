...
| Hex | Variable | Usage |
|---|---|---|
| <img src="https://placehold.co/24x24/9b2335/9b2335.png"/> `#9b2335` | `--accent` | Section headings, bullets, top borders, icon hover, PDF pill, landing separator |
| <img src="https://placehold.co/24x24/111111/111111.png"/> `#111` | `--text-1` | Names, job titles, education names |
| <img src="https://placehold.co/24x24/333333/333333.png"/> `#333` | `--text-body` | Summary, bullets, skill tags |
| <img src="https://placehold.co/24x24/555555/555555.png"/> `#555` | `--text-2` | Job company, landing role, education items |
| <img src="https://placehold.co/24x24/666666/666666.png"/> `#666` | `--text-3` | Tagline, landing location, skill group labels |
| <img src="https://placehold.co/24x24/767676/767676.png"/> `#767676` | `--text-dates` | Job dates |
| <img src="https://placehold.co/24x24/faf9f7/faf9f7.png"/> `#faf9f7` | `--bg` | Page background — warm off-white |
| <img src="https://placehold.co/24x24/edeae5/edeae5.png"/> `#edeae5` | `--bg-sidebar` | Resume sidebar — warm stone |
| <img src="https://placehold.co/24x24/dedad5/dedad5.png"/> `#dedad5` | `--border-mid` | Divider between main column and sidebar |
| <img src="https://placehold.co/24x24/eeeeee/eeeeee.png"/> `#eee` | `--border-sm` | Section rules, job separators |
| <img src="https://placehold.co/24x24/e0e0e0/e0e0e0.png"/> `#e0e0e0` | `--border` | Contact pill borders, icon-link rings |

### Dark mode tokens

| Hex | Variable | Usage |
|---|---|---|
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/3d3d3d/3d3d3d.png"/><img src="https://placehold.co/24x24/131313/131313.png"/></picture> `#131313` | `--bg` | Near-black page background |
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/464544/464544.png"/><img src="https://placehold.co/24x24/1c1b1a/1c1b1a.png"/></picture> `#1c1b1a` | `--bg-sidebar` | Slightly warm dark sidebar |
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/4c4c4c/4c4c4c.png"/><img src="https://placehold.co/24x24/222222/222222.png"/></picture> `#222222` | `--bg-skill` | Skill tag background |
| <img src="https://placehold.co/24x24/c4394e/c4394e.png"/> `#c4394e` | `--accent` | Brighter crimson for fills and borders |
| <img src="https://placehold.co/24x24/e0506a/e0506a.png"/> `#e0506a` | `--accent-text` | Even brighter — for text on dark backgrounds |
| <img src="https://placehold.co/24x24/f0ece8/f0ece8.png"/> `#f0ece8` | `--text-1` | Warm cream — names, titles |
| <img src="https://placehold.co/24x24/cccccc/cccccc.png"/> `#ccc` | `--text-body` | Body text |
| <img src="https://placehold.co/24x24/aaaaaa/aaaaaa.png"/> `#aaa` | `--text-2` | Secondary text |
| <img src="https://placehold.co/24x24/888888/888888.png"/> `#888` | `--text-3` | Muted text |
| <img src="https://placehold.co/24x24/878787/878787.png"/> `#878787` | `--text-dates` | Job dates |
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/727272/727272.png"/><img src="https://placehold.co/24x24/484848/484848.png"/></picture> `#484848` | `--border` | |
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/606060/606060.png"/><img src="https://placehold.co/24x24/363636/363636.png"/></picture> `#363636` | `--border-sm` | |
| <picture><source media="(prefers-color-scheme: dark)" srcset="https://placehold.co/24x24/62605e/62605e.png"/><img src="https://placehold.co/24x24/383634/383634.png"/></picture> `#383634` | `--border-mid` | |
