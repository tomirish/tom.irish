...
def test_index_template_has_jinja_variables():
    tmpl = read('src/index.template.html')
...
def test_index_template_loads_local_fonts():
    tmpl = read('src/index.template.html')
    assert '@font-face' in read('src/main.css'), 'Font declarations missing from main.css'
...
def test_resume_template_exists():
    assert exists('src/resume.template.html'), 'src/resume.template.html does not exist'


def test_resume_template_has_jinja_variables():
    tmpl = read('src/resume.template.html')
