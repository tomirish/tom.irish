...
## Session start
When working in this repo, the global MEMORY.md is not auto-loaded. Read it manually at the start of each session from your Codex project memory directory.
