...
Personal website and resume for [Tom Irish](https://tom.irish). `resume.md` is the single source of truth — a single Markdown file drives the entire site, generating both the HTML and a print-ready PDF automatically on every push.
